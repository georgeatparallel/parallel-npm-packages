...
describe('@parallel-web/ai-sdk-tools/v4', () => {
  describe('exports', () => {
    it('should export searchTool', async () => {
      ...
      expect(searchTool.parameters).toBeDefined(); // v4 uses 'parameters'
    ...
    it('should export extractTool', async () => {
      ...
      expect(extractTool.parameters).toBeDefined(); // v4 uses 'parameters'
  ...
  describe('searchTool - unit tests', () => {
    ...
    beforeAll(async () => {
      const module = await import('../v4/index.js');
  ...
  describe('extractTool - unit tests', () => {
    ...
    describe('parameter schema validation', () => {
      it('should accept valid objective and urls', () => {
        const result = extractTool.parameters.safeParse({
